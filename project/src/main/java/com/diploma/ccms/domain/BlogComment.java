...
public class BlogComment {
	...
	public static long countBlogComments() {
		return entityManager().createQuery(
				"SELECT COUNT(o) FROM BlogComment o", Long.class)
				.getSingleResult();
	}

	public static List<BlogComment> findAllBlogComments() {
		return entityManager().createQuery("SELECT o FROM BlogComment o",
				BlogComment.class).getResultList();
	}
	...
	public static List<BlogComment> findBlogCommentEntries(int firstResult,
			int maxResults) {
		return entityManager()
				.createQuery("SELECT o FROM BlogComment o", BlogComment.class)
