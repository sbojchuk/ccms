...
public class Blog {
	...
	public static long countBlogs() {
		return entityManager().createQuery("SELECT COUNT(o) FROM Blog o",
				Long.class).getSingleResult();
	}

	public static List<Blog> findAllBlogs() {
		return entityManager().createQuery("SELECT o FROM Blog o", Blog.class)
				.getResultList();
	}
	...
	public static TypedQuery<Blog> findBlogsByBodyLike(String body) {
		...
		TypedQuery<Blog> q = em
				.createQuery(
						"SELECT o FROM Blog AS o WHERE LOWER(o.body) LIKE LOWER(:body)",
						Blog.class);
	...
	public static TypedQuery<Blog> findBlogsByTitleLike(String title) {
		...
		TypedQuery<Blog> q = em
				.createQuery(
						"SELECT o FROM Blog AS o WHERE LOWER(o.title) LIKE LOWER(:title)",
						Blog.class);
