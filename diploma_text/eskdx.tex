...
\ESKDdocName{\uppercase{Пояснювальна записка}}
\ESKDgroup{\footnotesize{ІНФТУНГ ПЗ-07-1}} %get correct font fot that
...
\setlength{\ESKDsubsubsectionSkipAfter}{1mm \@plus 1mm \@minus 2mm} %TODO need less space
